...
export const glossary = {
    ...
    landing_image: '/images/kb.png',
    about_text: "<div>Hi! I'm Karim Bakkes 👋, I'm passionate about creating the technical and visual aspects of digital products. I am specialized in Front-end development, where I am also used to doing back-end tasks. I really like to keep up with the latest techniques in web developement to keep myself up to date.</div><div>I have a bachelors degree in <a href='https://www.hogeschoolrotterdam.nl/opleidingen/bachelor/creative-media-and-game-technologies/voltijd/' target='_blank'>Creative Media & Game Technologies</a>  from Hogeschool Rotterdam 🇳🇱 and a <a href='https://www.certmetrics.com/adobe/public/verification.aspx' target='_blank'>Magento 2 Front-end Expert Certificate</a>.</div><div>I personally think that making data visible and interactive for users is one of the most fun parts of web development. In my spare time, I like to work on hobby projects to improve my Javascript skills and to familiarize myself with newer techniques such as Redux.</div>",
...
export const projects = [
    ...
    },
    {
        ...
        image: '/images/ringCollector.png',
